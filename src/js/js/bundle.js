...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tabs = function () {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).on("click", () => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).addClass("tabs-item--active").fadeIn(1500, "block").siblings().removeClass("tabs-item--active").closest(".tabs").find(".tabs-content").removeClass("tabs-content--active").eq(Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).index()).addClass("tabs-content--active");
    });
  }
};

Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])("[data-tabpanel] .tabs-item").tabs();

/***/ }),

/***/ "./src/js/lib/components/timer.js":
/*!****************************************!*\
  !*** ./src/js/lib/components/timer.js ***!
  \****************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.timer = function (timerSelector, deadline) {
...
/* harmony import */ var _components_timer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/timer */ "./src/js/lib/components/timer.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animateOverTime = function (duration, fade, finalAnimation) {
  let timeStart = 0;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._fadeIn = function (duration, display, finalAnimation, i) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._fadeOut = function (duration, finalAnimation, i) {
  const _fade = complection => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (duration, display, finalAnimation) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function (duration, finalAnimation) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function (duration, display, finalAnimation) {
  for (let i = 0; i < this.length; i++) {
